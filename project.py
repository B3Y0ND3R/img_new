...
print("\n1.1 Manual Histogram Equalization:")
manual_he=histogram_equalization(cells)
cv2_imshow(manual_he)
...
print("\nBlurred Cells (Gaussian σ=1.0):")
cv2_imshow(blurred_cells)
...
print("\n4.6 Segmented Borders on Original Image:")
cv2_imshow(cv2.cvtColor(impose,cv2.COLOR_RGB2BGR))
